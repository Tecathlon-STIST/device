# This is the source of the AI model itself, which you might be looking for during evaluation.
# This is based on the research paper 'Using End-to-End Deep Learning Models to Steer A Car' by NVIDIA, Google Research & New York University
# The paper itself can be found here: https://arxiv.org/pdf/1704.07911.pdf
...
class PilotNet():
    ...
    def build_model(self):
        ...
        # the paper suggests the model giving only one output
        # However, we can technically use backtracking to get accurate values for brake & throttle
        # with this project, the brakes are an important part of what we need
    ...
    def predict(self, data, given_model = 'default'):
        if given_model != 'default':
            try:
                ...
                raise Error('An unexpected error occured when loading the saved model. Please rerun...')
